  ...
  return (
    <div className="logo">
      <a href="/">
        <img
          alt="logo"
          src="https://img.freepik.com/free-vector/hand-drawn-spicy-logo-design_23-2149667267.jpg?w=740&t=st=1676299452~exp=1676300052~hmac=e599cd61d23b4e7298745610cc5399405a0fa199b2600f05390cc1bab6a002e0"
        />
      </a>
    </div>
  );
  ...
  return (
    <>
      ...
      <div className="restraunt-list">
        {restrautList.map((restr) => {
          return <RestrauntCard restraunt={restr} />;
        })}
      </div>
    </>
  );
...
const Footer = () => {
  return (
    <div class="footer">
      <p>
        Copywrite 2023 <a href="#">React Practice </a>| created by
        <a href="#">Ranjana</a>
      </p>
    </div>
  );
